...
/* package implement-0.1.0.0 */
#ifndef VERSION_implement
#define VERSION_implement "0.1.0.0"
#endif /* VERSION_implement */
#ifndef MIN_VERSION_implement
#define MIN_VERSION_implement(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_implement */
...
#define CURRENT_COMPONENT_ID "implement-0.1.0.0-inplace-src"
